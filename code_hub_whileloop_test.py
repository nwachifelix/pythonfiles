# List of numbers
listOfStuff = [21, 33, 77, 2, 4, 10, 3, 17]  #index 0 - 7

# This while loop starts listing the odd and even from index 7 which is number 17
my_nums = len(listOfStuff)   #first, determine list length = 8
count = 0
print('while loop') #While loop
while count < my_nums:  #True
